...
description: "Microsoft Semantic Kernel agents"
version: "1.0"
trigger: "semantic kernel microsoft agent"
platforms: []
...
## Purpose
Microsoft Semantic Kernel agents for building autonomous AI agent systems with specific frameworks and tools.
