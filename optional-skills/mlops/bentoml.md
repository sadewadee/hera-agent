---
name: bentoml
description: "BentoML model serving framework"
version: "1.0"
trigger: "bentoml model serving deployment"
platforms: []
...
## Purpose
BentoML model serving framework for production ML workflows and model lifecycle management.
