---
name: matrix
description: "Matrix protocol messaging"
version: "1.0"
trigger: "matrix protocol chat federated"
platforms: []
...
## Purpose
Matrix protocol messaging for automated messaging and communication platform integration.
