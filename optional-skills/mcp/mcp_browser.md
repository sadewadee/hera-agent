...
version: "1.0"
trigger: "mcp browser web scrape navigate"
platforms: []
...
## Purpose
MCP browser automation server for extending AI agent capabilities through specialized MCP server implementations.
