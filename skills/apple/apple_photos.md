---
name: apple_photos
description: "Apple Photos library management"
version: "1.0"
trigger: "apple photos library search"
platforms: ["macos", "ios"]
requires_tools: ["run_command"]
---

# Apple Photos library management

## Purpose
Apple Photos library management through the Hera agent interface, enabling hands-free control and automation of Apple ecosystem features.

## Instructions
1. Parse the user's intent regarding apple photos functionality
