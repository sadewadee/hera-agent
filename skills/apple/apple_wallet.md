---
name: apple_wallet
description: "Apple Wallet and passes management"
version: "1.0"
trigger: "apple wallet passes payment"
platforms: ["macos", "ios"]
requires_tools: ["run_command"]
---

# Apple Wallet and passes management

## Purpose
Apple Wallet and passes management through the Hera agent interface, enabling hands-free control and automation of Apple ecosystem features.

## Instructions
1. Parse the user's intent regarding apple wallet functionality
