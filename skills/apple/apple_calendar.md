---
name: apple_calendar
description: "Apple Calendar event management"
version: "1.0"
trigger: "apple calendar events scheduling"
platforms: ["macos", "ios"]
requires_tools: ["run_command"]
---

# Apple Calendar event management

## Purpose
Apple Calendar event management through the Hera agent interface, enabling hands-free control and automation of Apple ecosystem features.

## Instructions
1. Parse the user's intent regarding apple calendar functionality
