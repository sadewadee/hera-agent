---
name: apple_mail
description: "Apple Mail automation"
version: "1.0"
trigger: "apple mail email automation"
platforms: ["macos", "ios"]
...
## Purpose
Apple Mail automation through the Hera agent interface, enabling hands-free control and automation of Apple ecosystem features.

## Instructions
1. Parse the user's intent regarding apple mail functionality
