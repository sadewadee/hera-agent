---
name: apple_notes
description: "Apple Notes creation and search"
version: "1.0"
trigger: "apple notes search create"
platforms: ["macos", "ios"]
requires_tools: ["run_command"]
---

# Apple Notes creation and search

## Purpose
Apple Notes creation and search through the Hera agent interface, enabling hands-free control and automation of Apple ecosystem features.

## Instructions
1. Parse the user's intent regarding apple notes functionality
