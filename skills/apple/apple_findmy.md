---
name: apple_findmy
description: "Apple Find My device tracking"
version: "1.0"
trigger: "apple find my device tracking"
platforms: ["macos", "ios"]
...
## Purpose
Apple Find My device tracking through the Hera agent interface, enabling hands-free control and automation of Apple ecosystem features.

## Instructions
1. Parse the user's intent regarding apple findmy functionality
