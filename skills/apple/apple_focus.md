---
name: apple_focus
description: "Apple Focus modes management"
version: "1.0"
trigger: "apple focus mode do not disturb"
platforms: ["macos", "ios"]
requires_tools: ["run_command"]
---

# Apple Focus modes management

## Purpose
Apple Focus modes management through the Hera agent interface, enabling hands-free control and automation of Apple ecosystem features.

## Instructions
1. Parse the user's intent regarding apple focus functionality
