...
description: "Apple Reminders task management"
version: "1.0"
trigger: "apple reminders tasks todos"
platforms: ["macos", "ios"]
...
## Purpose
Apple Reminders task management through the Hera agent interface, enabling hands-free control and automation of Apple ecosystem features.

## Instructions
1. Parse the user's intent regarding apple reminders functionality
