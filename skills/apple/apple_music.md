---
name: apple_music
description: "Apple Music playback and playlist control"
version: "1.0"
trigger: "apple music playback playlist"
platforms: ["macos", "ios"]
requires_tools: ["run_command"]
---

# Apple Music playback and playlist control

## Purpose
Apple Music playback and playlist control through the Hera agent interface, enabling hands-free control and automation of Apple ecosystem features.

## Instructions
1. Parse the user's intent regarding apple music functionality
