---
name: reflection
description: "Agent self-reflection and error correction"
version: "1.0"
trigger: "agent reflection self-correction"
platforms: []
requires_tools: []
---

# Agent self-reflection and error correction

## Purpose
Agent self-reflection and error correction for building and orchestrating autonomous AI agent systems.
