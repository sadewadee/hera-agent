---
name: grounding
description: "Agent grounding with external knowledge"
version: "1.0"
trigger: "agent grounding rag knowledge"
platforms: []
requires_tools: []
---

# Agent grounding with external knowledge

## Purpose
Agent grounding with external knowledge for building and orchestrating autonomous AI agent systems.
