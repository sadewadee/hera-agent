---
name: code_agent
description: "Code generation and execution agents"
version: "1.0"
trigger: "code agent execution sandbox"
platforms: []
...
## Purpose
Code generation and execution agents for building and orchestrating autonomous AI agent systems.
