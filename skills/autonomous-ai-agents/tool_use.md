---
name: tool_use
description: "Agent tool selection and orchestration"
version: "1.0"
trigger: "agent tool use function calling"
platforms: []
requires_tools: ["run_command"]
---

# Agent tool selection and orchestration

## Purpose
Agent tool selection and orchestration for building and orchestrating autonomous AI agent systems.
