---
name: gantt
description: "Gantt chart and project timeline creation"
version: "1.0"
trigger: "gantt chart project timeline schedule"
platforms: []
requires_tools: []
---

# Gantt chart and project timeline creation

## Purpose
Gantt chart and project timeline creation using text-based diagramming tools (Mermaid, PlantUML, D2) for documentation and communication.
