---
name: class_diagram
description: "UML class diagram generation"
version: "1.0"
trigger: "class diagram uml object oriented"
platforms: []
requires_tools: []
---
...
## Purpose
UML class diagram generation using text-based diagramming tools (Mermaid, PlantUML, D2) for documentation and communication.
