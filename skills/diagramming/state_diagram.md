---
name: state_diagram
description: "State machine diagram creation"
version: "1.0"
trigger: "state diagram state machine transitions"
platforms: []
requires_tools: []
---
...
## Purpose
State machine diagram creation using text-based diagramming tools (Mermaid, PlantUML, D2) for documentation and communication.
