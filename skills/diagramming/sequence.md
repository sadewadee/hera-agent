...
version: "1.0"
trigger: "sequence diagram interaction flow"
platforms: []
requires_tools: []
---
...
## Purpose
Sequence diagram creation using text-based diagramming tools (Mermaid, PlantUML, D2) for documentation and communication.
