...
version: "1.0"
trigger: "er diagram entity relationship database"
platforms: []
requires_tools: []
---
...
## Purpose
Entity-relationship diagram creation using text-based diagramming tools (Mermaid, PlantUML, D2) for documentation and communication.
