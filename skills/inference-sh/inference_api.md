---
name: inference_api
description: "Inference API endpoint management"
version: "1.0"
trigger: "inference api endpoint serve"
platforms: []
requires_tools: ["run_command"]
---

# Inference API endpoint management

## Purpose
Inference API endpoint management using inference.sh platform for ML model hosting and API management.
