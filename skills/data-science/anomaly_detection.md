...
version: "1.0"
trigger: "anomaly detection outlier fraud"
platforms: []
...
## Purpose
Apply anomaly detection techniques to extract insights from data, supporting both exploratory analysis and production data pipelines.
