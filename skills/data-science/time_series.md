...
version: "1.0"
trigger: "time series forecasting arima prophet"
platforms: []
...
## Purpose
Apply time series techniques to extract insights from data, supporting both exploratory analysis and production data pipelines.
