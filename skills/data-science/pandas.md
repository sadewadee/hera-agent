...
version: "1.0"
trigger: "pandas dataframe data manipulation"
platforms: []
...
## Purpose
Apply pandas techniques to extract insights from data, supporting both exploratory analysis and production data pipelines.
