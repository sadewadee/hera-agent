...
version: "1.0"
trigger: "classification random forest svm decision tree"
platforms: []
...
## Purpose
Apply classification techniques to extract insights from data, supporting both exploratory analysis and production data pipelines.
