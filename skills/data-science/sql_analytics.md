---
name: sql_analytics
description: "SQL for data analytics"
version: "1.0"
trigger: "sql analytics query window functions"
platforms: []
...
## Purpose
Apply sql analytics techniques to extract insights from data, supporting both exploratory analysis and production data pipelines.
