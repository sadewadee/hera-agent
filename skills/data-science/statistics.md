...
version: "1.0"
trigger: "statistics analysis hypothesis test"
platforms: []
...
## Purpose
Apply statistics techniques to extract insights from data, supporting both exploratory analysis and production data pipelines.
