...
version: "1.0"
trigger: "ab testing experiment design statistical"
platforms: []
...
## Purpose
Apply ab testing ds techniques to extract insights from data, supporting both exploratory analysis and production data pipelines.
