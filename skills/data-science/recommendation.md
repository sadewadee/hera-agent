...
version: "1.0"
trigger: "recommendation system collaborative content filtering"
platforms: []
...
## Purpose
Apply recommendation techniques to extract insights from data, supporting both exploratory analysis and production data pipelines.
