...
version: "1.0"
trigger: "data visualization chart plot graph"
platforms: []
...
## Purpose
Apply visualization techniques to extract insights from data, supporting both exploratory analysis and production data pipelines.
