...
version: "1.0"
trigger: "geospatial gis mapping spatial analysis"
platforms: []
...
## Purpose
Apply geospatial techniques to extract insights from data, supporting both exploratory analysis and production data pipelines.
