...
version: "1.0"
trigger: "ansible configuration management playbook"
platforms: []
...
## Purpose
Configuration management with Ansible for reliable, scalable, and maintainable infrastructure and deployment pipelines.
